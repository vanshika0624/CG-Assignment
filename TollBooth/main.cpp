...
static void key(unsigned char key1, int x, int y)
{
	...
	void welcome()
	{
			...
			glColor3f(0.0,1.0,1.0);
	 		...
	 		drawstring(180,260,0.0,"THINKERS");
		...
		void frontscreen()
	{
		...
		glColor3f(0.0,0.0,0.0);
	 	...
	 	glColor3f(0.0,0.0,1.0);
	 		drawstring2(20,265,0.0,"Name with USN");
	 		drawstring2(20,290,0.0,"Name with USN");
	 	glColor3f(1.0,1.0,1.0);
	 		drawstring1(10,230,0.0,"Under the Guidance of");
	 	glColor3f(0.0,1.0,0.0);
	 		drawstring2(20,200,0.0,"Prof. ");
	 	glColor3f(0.0,0.0,0.0);
	 		drawstring1(20,90,0.0,"Year:- ");
